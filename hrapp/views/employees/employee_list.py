...
def employee_list(request):
    if request.method == 'GET':
        with sqlite3.connect("/Users/laurenriddle/workspace/python/book-three/bangazon-group-project/bangazon-workforce-mgt-imagination-station/db.sqlite3") as conn:
